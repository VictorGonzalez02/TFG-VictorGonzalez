...
private:
	...
	GLuint flattenedNodesBufferFloats;
	GLuint flattenedNodesBufferInts;
	GLuint flattenedPointsBuffer;
	GLuint flattenedNodesTextureInts;
	GLuint flattenedNodesTextureFloats;
	GLuint flattenedPointsTexture;

	GLuint flattenedNodesErrorBufferFloats;
	GLuint flattenedNodesErrorBufferInts;
	GLuint flattenedPointsErrorBuffer;
	GLuint flattenedNodesErrorTextureInts;
	GLuint flattenedNodesErrorTextureFloats;
	GLuint flattenedPointsErrorTexture;
